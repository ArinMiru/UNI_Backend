...
import community.question.process.QuesBubTtableOut;
...
@WebServlet("/QuesBubSvc")
public class QuesBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QuesBubTtableOut openBubListTtableOut = new QuesBubTtableOut(jobj);
