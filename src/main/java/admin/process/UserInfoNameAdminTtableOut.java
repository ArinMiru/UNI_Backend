...
public class UserInfoNameAdminTtableOut {    
	
	private JSONObject jObjMain = new JSONObject();

	public UserInfoNameAdminTtableOut (Map<String, Object> param) throws IOException {
		...
		try {
			...
			rtnList = session.selectList("uni-account-mapping.selectNameMembInfoAdmin",param);
