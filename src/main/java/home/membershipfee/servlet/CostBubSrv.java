...
import home.membershipfee.process.CostBubTtableOut;
...
@WebServlet("/CostBubSvc")
public class CostBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CostBubTtableOut costBubListTtableOut = new CostBubTtableOut(jobj);
