...
public class MembNicUpd {    
	
	// MAIN 생성용 OBJECT
	private JSONObject jObjMain = new JSONObject();
	
	public MembNicUpd (Map<String, Object> param) throws IOException {
	//public LonginTtableOut (String userId,String userType,String userPasswrd) throws IOException {
        ...
        try {
            ...
            int updatedRows = session.update("uni-account-mapping.updateMembNicUpd",param);
