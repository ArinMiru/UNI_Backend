...
import home.vote.process.VotBubListTtableOut;
 ...
 */
@WebServlet("/VotBubListSvc")
public class VotBubListSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VotBubListSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		VotBubListTtableOut votTtableOut = new VotBubListTtableOut(param);
		
		resltObj = votTtableOut.getResult();
