...
import gallery.process.GallBubTtableOut;
...
@WebServlet("/GallBubSvc")
public class GallBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GallBubTtableOut gallBubListTtableOut = new GallBubTtableOut(jobj);
