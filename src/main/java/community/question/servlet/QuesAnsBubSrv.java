...
import community.question.process.QuesAnsBubTtableOut;
...
@WebServlet("/QuesAnsBubSvc")
public class QuesAnsBubSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuesAnsBubSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QuesAnsBubTtableOut openBubListTtableOut = new QuesAnsBubTtableOut(jobj);
