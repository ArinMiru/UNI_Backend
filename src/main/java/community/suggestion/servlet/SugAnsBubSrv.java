...
import community.suggestion.process.SugAnsBubTtableOut;
...
@WebServlet("/SugAnsBubSvc")
public class SugAnsBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SugAnsBubTtableOut sugBubListTtableOut = new SugAnsBubTtableOut(jobj);
