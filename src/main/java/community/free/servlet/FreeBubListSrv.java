package community.free.servlet;
...
import community.free.process.FreeBubListTtableOut;
 ...
 */
@WebServlet("/FreeBubListSvc")
public class FreeBubListSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeBubListSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FreeBubListTtableOut longinTtableOut = new FreeBubListTtableOut(param);
