...
import gallery.process.GallAnsBubTtableOut;
...
@WebServlet("/GallAnsBubSvc")
public class GallAnsBubSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GallAnsBubSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GallAnsBubTtableOut gallBubListTtableOut = new GallAnsBubTtableOut(jobj);
