...
import community.market.process.MarkAnsBubTtableOut;
...
@WebServlet("/MarkAnsBubSvc")
public class MarkAnsBubSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MarkAnsBubSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MarkAnsBubTtableOut markBubListTtableOut = new MarkAnsBubTtableOut(jobj);
