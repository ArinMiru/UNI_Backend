...
import community.free.process.FreeBubTtableOut;
...
@WebServlet("/FreeBubSvc")
public class FreeBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FreeBubTtableOut openBubListTtableOut = new FreeBubTtableOut(jobj);
