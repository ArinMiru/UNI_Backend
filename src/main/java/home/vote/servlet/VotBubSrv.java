...
import home.vote.process.VotBubTtableOut;
...
@WebServlet("/VotBubSvc")
public class VotBubSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		VotBubTtableOut votBubListTtableOut = new VotBubTtableOut(jobj);
		
		resltObj = votBubListTtableOut.getResult();
