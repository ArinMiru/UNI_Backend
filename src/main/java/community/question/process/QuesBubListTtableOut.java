...
public class QuesBubListTtableOut {    
	
	private JSONObject jobj = new JSONObject();
	
	public QuesBubListTtableOut (Map<String, Object> param) throws IOException {
	//public LonginTtableOut (String userId,String userType,String userPasswrd) throws IOException {
		...
		try {
			...
			rtnList = session.selectList("uni-community-mapping.selectQuesBubInfo",param);	
			...
			for (int i=0; i < rtnList.size() ;i++)
			{
				...
				rtnListSub2 = session.selectList("uni-community-mapping.selectQuesAnsInfo",param);	
