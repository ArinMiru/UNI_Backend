...
import account.process.MembLikeMinusUpd;

/**
 * Servlet implementation class LoginSrv
 */

@WebServlet("/MembLikeMinusUpdSvc")
public class MembLikeMinusUpdSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MembLikeMinusUpdSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MembLikeMinusUpd membinfoupd = new MembLikeMinusUpd(jobj);
