...
import admin.process.AskAdmin;

/**
 * Servlet implementation class LoginSrv
 */
@WebServlet("/AskAdminSrv")
public class AskAdminSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AskAdmin askadmin = new AskAdmin(param);
		
		resltObj = askadmin.getResult();
