...
import home.notice.process.OpenBubListTtableOut;
...
@WebServlet("/OpenBubListSvc")
public class OpenBubListSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OpenBubListSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		OpenBubListTtableOut openBubListTtableOut = new OpenBubListTtableOut(param);
