...
import community.question.process.QuesBubListTtableOut;
 ...
 */
@WebServlet("/QuesBubListSvc")
public class QuesBubListSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuesBubListSrv() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QuesBubListTtableOut longinTtableOut = new QuesBubListTtableOut(param);
