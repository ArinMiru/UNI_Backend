...
import home.vote.process.VotVotTtableOut;
...
@WebServlet("/VotVotSvc")
public class VotVotSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		VotVotTtableOut votVotListTtableOut = new VotVotTtableOut(jobj);
		
		resltObj = votVotListTtableOut.getResult();
